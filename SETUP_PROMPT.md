...
11. Run:
   ...
   - Claude skills from `~/.claude/skills/<name>/SKILL.md` should appear as generated wrappers at `$CODEX_HOME/skills/<name>/SKILL.md`, or `~/.codex/skills/<name>/SKILL.md` when `CODEX_HOME` is unset.
   ...
   - Do not symlink raw Claude skill directories into `$CODEX_HOME/skills` or `~/.codex/skills`; raw Claude skill frontmatter may be missing or use YAML that Codex rejects.
